package dev.nara.external;

import dev.nara.external.domain.LivingPerson;
import dev.nara.hacker.PersonOfInterest;
...
public class MainImmutable {
	...
	public static void main(String[] args) {
		...
		PersonImmutable john = new PersonImmutable("John", "04/04/1900", johnsKids);
		System.out.println(john);

		PersonImmutable[] kids = john.getKids();
		kids[0] = jim;
		kids[1] = new PersonImmutable("Ann", "05/05/1936");
		System.out.println(john);

		johnsKids[0] = new PersonImmutable("Ann", "05/05/1936");
		System.out.println(john);
